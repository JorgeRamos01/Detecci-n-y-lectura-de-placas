...
# To run: python3 mark_plates.py test_img results/real_tests haar
# python3 mark_plates.py test_img/ results/real_test_marked_plates canny
...
for filename in sorted(files):
	...
	for x,y,w,h in recog.lista_placas:
		...
		temp_img = recog.img_re.copy()

		cv2.rectangle(temp_img, (x, y),(x + w, y + h), (0,0, 255), 4)
